...
values ('00000001', '计算机科学', '这是一门测试课程', 7200, 19.9, '', 1, 'C', 'P', 100, 0, now(), now());
insert into course (id, name, summary, time, price, image, level, charge, status, enroll, sort, created_at, updated_at)
values ('00000002', '心理学科学', '这是一门测试课程', 7200, 29.9, '', 1, 'C', 'P', 100, 0, now(), now());
...
insert into `chapter` (id, course_id, name)
values ('00000008', '00000002', '测试大章08');
insert into `chapter` (id, course_id, name)
values ('00000009', '00000002', '测试大章09');
insert into `chapter` (id, course_id, name)
values ('00000010', '00000002', '测试大章10');
insert into `chapter` (id, course_id, name)
values ('00000011', '00000002', '测试大章11');
insert into `chapter` (id, course_id, name)
values ('00000012', '00000002', '测试大章12');
insert into `chapter` (id, course_id, name)
values ('00000013', '00000002', '测试大章13');
insert into `chapter` (id, course_id, name)
values ('00000014', '00000002', '测试大章14');
...
insert into `section` (id, title, course_id, chapter_id, video, time, charge, sort, created_at, updated_at)
values ('00000003', '测试小节01', '00000002', '00000001', '', 500, 'f', 1, now(), now());
insert into `section` (id, title, course_id, chapter_id, video, time, charge, sort, created_at, updated_at)
values ('00000004', '测试小节02', '00000002', '00000001', '', 500, 'f', 1, now(), now());
