...
//            toJson(SmsStatusEnum.class, bufferObject, bufferArray);
    ...
    private static void toJson(Class clazz, StringBuffer bufferObject, StringBuffer bufferArray) throws Exception {
        ...
        toJsonWithKey(clazz, key, bufferObject, bufferArray);
    }

    private static void toJsonWithKey(Class clazz, String key, StringBuffer bufferObject, StringBuffer bufferArray) throws Exception {
