...
public class DbUtil {
    ...
    public static Connection getConnection() {
        ...
        try {
            ...
            String url = "jdbc:mysql://localhost:3306/evideo?characterEncoding=utf8&useSSL=true&serverTimezone=UTC&zeroDateTimeBehavior=CONVERT_TO_NULL";
            String user = "root";
            String pass = "nroot";
